...
from src.config import LABEL_MAP, MAX_LENGTH, MODEL_PATH
...
class SarcasmPredictor:
    ...
    def predict(self, text: str) -> dict:
        ...
        if predicted_idx not in LABEL_MAP:
            raise ValueError(
                f"Model returned unexpected class index {predicted_idx}. "
                f"Configured LABEL_MAP: {LABEL_MAP}"
            )
